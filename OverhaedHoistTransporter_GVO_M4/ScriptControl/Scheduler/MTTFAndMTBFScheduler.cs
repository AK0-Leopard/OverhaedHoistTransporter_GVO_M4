...
namespace com.mirle.ibg3k0.sc.Scheduler
{
    public class MTTFAndMTBFScheduler : IJob
    {
        ...
        NLog.Logger logger_mttfmtbf_ohtc = NLog.LogManager.GetLogger("MTTFMTBF_OHTC_Record");
        ...
        private void ReocrdMTTFMTBFForOHTC()
        {
            ...
            logger_mttfmtbf_ohtc.Info(record_message);
        }
