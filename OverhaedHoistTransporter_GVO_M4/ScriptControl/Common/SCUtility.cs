...
namespace com.mirle.ibg3k0.sc.Common
{
    ...
    public class SCUtility
    {
        ...
        string fun_name, int seq_num, string vh_id, string cmd, string act_type,
        string transferCmdID,
        ...
        string result)
        {
            ...
            logEntry.CST = Trim(vh_DO.CST_ID, true);
            logEntry.CMD = Trim(vh_DO.CMD_ID, true);
            logEntry.TRAN_CMD_ID = Trim(vh_DO.TRANSFER_ID, true);
        ...
        public static void RecodeReportInfo(string vh_id, int seq_num, ID_31_TRANS_REQUEST send_str)
        {
            ...
            RecordReportInfo(MSG_ROLE_VH, MSG_ROLE_CONTROL,
                fun_name, seq_num, vh_id, vh_DO.CMD_ID, send_str.ActType.ToString(),
                vh_DO.TRANSFER_ID,  //S2F49
                vh_DO.CUR_ADR_ID, vh_DO.CUR_SEC_ID, string.Empty, (uint)vh_DO.ACC_SEC_DIST, string.Empty, string.Empty, //134
                0, 0,//134 reply
                0,
