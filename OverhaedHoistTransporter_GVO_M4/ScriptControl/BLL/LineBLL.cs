    ...
    public class LineBLL
    {
        ...
        public static byte[] Convert2GPB_TcpMsgInfo(dynamic logEntry)
        {
            ...
            try
            {
                ...
                eq_gpp.OHTCCMDID = logEntry.OHTC_CMD_ID == null?"": logEntry.OHTC_CMD_ID;
                //eq_gpp.ACTTYPE = logEntry.ACT_TYPE;
                eq_gpp.ACTTYPE = logEntry.ACT_TYPE == null?"": logEntry.ACT_TYPE;
                //eq_gpp.MCSCMDID = logEntry.MCS_CMD_ID;
                eq_gpp.MCSCMDID = logEntry.MCSCMDID == null?"": logEntry.MCSCMDID;
        ...
        public static byte[] Convert2GPB_PingCheckInfo(ALINE line)
        {
            PING_CHECK_INFO ping_gpb = new PING_CHECK_INFO()
            {
                ...
                OHT1ConnectionSuccess = line.AGV1ConnectionSuccess,
                OHT2ConnectionSuccess = line.AGV2ConnectionSuccess,
                OHT3ConnectionSuccess = line.AGV3ConnectionSuccess,
                OHT4ConnectionSuccess = line.AGV4ConnectionSuccess,
                OHT5ConnectionSuccess = line.AGV5ConnectionSuccess,
                OHT6ConnectionSuccess = line.AGV6ConnectionSuccess,
                OHT7ConnectionSuccess = line.AGV7ConnectionSuccess,
                OHT8ConnectionSuccess = line.AGV8ConnectionSuccess,
                OHT9ConnectionSuccess = line.AGV9ConnectionSuccess,
                OHT10ConnectionSuccess = line.AGV10ConnectionSuccess,
                OHT11ConnectionSuccess = line.AGV11ConnectionSuccess,
                OHT12ConnectionSuccess = line.AGV12ConnectionSuccess,
                OHT13ConnectionSuccess = line.AGV13ConnectionSuccess,
                OHT14ConnectionSuccess = line.AGV14ConnectionSuccess,
        ...
        public static byte[] Convert2GPB_MTLMTSInfo(MaintainLift MTL)
        {
            MTL_MTS_INFO online_gpb = new MTL_MTS_INFO()
            {
                ...
                OHTCCarOutInterlock = MTL.OHTCCarOutInterlock,
                OHTCCarInMoving = MTL.OHTCCarOutMoving
            };
