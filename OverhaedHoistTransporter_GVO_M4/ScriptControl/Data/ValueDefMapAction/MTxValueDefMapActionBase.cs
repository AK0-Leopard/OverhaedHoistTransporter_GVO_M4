...
namespace com.mirle.ibg3k0.sc.Data.ValueDefMapAction
{
    public abstract class MTxValueDefMapActionBase : IValueDefMapAction
    {
        ...
        public virtual bool setOHxC2MTL_CarOutReady(bool carOutReady)
        {
            try
            {
                ValueWrite vm_carOutReady = bcfApp.getWriteValueEvent(eqpt.EqptObjectCate, eqpt.EQPT_ID, "OHXC_TO_MTL_CAR_OUT_READY");
        ...
        public virtual bool setOHxC2MTL_CarOutMoveComplete(bool carOutMoveComplete)
        {
            try
            {
                ValueWrite vm_carOutMoveComplete = bcfApp.getWriteValueEvent(eqpt.EqptObjectCate, eqpt.EQPT_ID, "OHXC_TO_MTL_CAR_OUT_MOVE_COMPLETE");
        ...
        public virtual bool setOHxC2MTL_CarOutMoving(bool carMoving)
        {
            try
            {
        ...
        public virtual bool setOHxC2MTL_CarInInterlock(bool interlock)
        {
            try
            {
                ValueWrite vm_car_in_interlock = bcfApp.getWriteValueEvent(eqpt.EqptObjectCate, eqpt.EQPT_ID, "OHXC_TO_MTL_CAR_IN_INTERLOCK");
        ...
        public virtual bool setOHxC2MTL_CarInMoveComplete(bool move_complete)
        {
            try
            {
                ValueWrite vm_car_in_move_complete = bcfApp.getWriteValueEvent(eqpt.EqptObjectCate, eqpt.EQPT_ID, "OHXC_TO_MTL_CAR_IN_MOVE_COMPLETE");
        ...
        public virtual void OHxC2MTL_CarInInterface(bool carMoving, bool car_in_interlock, bool car_in_move_complete)
        {
            try
            {
                ValueWrite vm_carMoving = bcfApp.getWriteValueEvent(eqpt.EqptObjectCate, eqpt.EQPT_ID, "OHXC_TO_MTL_CAR_IN_MOVING");
                ValueWrite vm_carInInterlock = bcfApp.getWriteValueEvent(eqpt.EqptObjectCate, eqpt.EQPT_ID, "OHXC_TO_MTL_CAR_IN_INTERLOCK");
                ValueWrite vm_carInMoveComplete = bcfApp.getWriteValueEvent(eqpt.EqptObjectCate, eqpt.EQPT_ID, "OHXC_TO_MTL_CAR_IN_MOVE_COMPLETE");
                vm_carMoving.setWriteValue(carMoving ? "1" : "0");
        ...
        public virtual void CarOutSafetyChcek(object sender, ValueChangedEventArgs args)
        {
            ...
            try
            {
                ...
                LogHelper.Log(logger: logger, LogLevel: LogLevel.Info, Class: nameof(MTxValueDefMapActionBase), Device: SCAppConstants.DeviceName.DEVICE_NAME_MTx,
                         ...
                         XID: eqpt.EQPT_ID);
                eqpt.MTLCarOutSafetyCheck = recevie_function.CarOutSafetyCheck;
        ...
        public virtual void CarOutInterlock(object sender, ValueChangedEventArgs args)
        {
            var recevie_function =
                scApp.getFunBaseObj<MtlToOHxC_CarOutInterlock>(eqpt.EQPT_ID) as MtlToOHxC_CarOutInterlock;
            try
            {
                recevie_function.Read(bcfApp, eqpt.EqptObjectCate, eqpt.EQPT_ID);
                LogHelper.Log(logger: logger, LogLevel: LogLevel.Info, Class: nameof(MTxValueDefMapActionBase), Device: SCAppConstants.DeviceName.DEVICE_NAME_MTx,
        ...
        public virtual void CarInInterlock(object sender, ValueChangedEventArgs args)
        {
            var recevie_function =
                scApp.getFunBaseObj<MtlToOHxC_CarInInterlock>(eqpt.EQPT_ID) as MtlToOHxC_CarInInterlock;
            try
            {
                recevie_function.Read(bcfApp, eqpt.EqptObjectCate, eqpt.EQPT_ID);
                LogHelper.Log(logger: logger, LogLevel: LogLevel.Info, Class: nameof(MTxValueDefMapActionBase), Device: SCAppConstants.DeviceName.DEVICE_NAME_MTx,
                         Data: recevie_function.ToString(),
                         XID: eqpt.EQPT_ID);
                eqpt.MTLCarInInterlock = recevie_function.CarInInterlock;
                eqpt.SynchronizeTime = DateTime.Now;
        ...
        public virtual (bool isSendSuccess, UInt16 returnCode) OHxC_CarOutRequestCancelNotify()
        {
            return (false, 0);
        }
        ...
        public abstract void MTL_CarInRequestCancel(object sender, ValueChangedEventArgs args);
        public abstract void MTL_ManualCarOutRequest(object sender, ValueChangedEventArgs args);
        public abstract void MTL_ManualCarOutFinish(object sender, ValueChangedEventArgs args);
        public abstract void MTLSafetyStatusChanged(object sender, ValueChangedEventArgs args);
        ...
        public virtual void doInit()
        {
            ...
            {
                ValueRead vr = null;
                if (bcfApp.tryGetReadValueEventstring(eqpt.EqptObjectCate, eqpt.EQPT_ID, "MTL_TO_OHXC_CAR_OUT_SAFETY_CHECK", out vr))
                {
                    vr.afterValueChange += (_sender, _e) => CarOutSafetyChcek(_sender, _e);
                }
                if (bcfApp.tryGetReadValueEventstring(eqpt.EqptObjectCate, eqpt.EQPT_ID, "MTL_TO_OHXC_CAR_OUT_INTERLOCK", out vr))
                {
                    vr.afterValueChange += (_sender, _e) => CarOutInterlock(_sender, _e);
                }
                if (bcfApp.tryGetReadValueEventstring(eqpt.EqptObjectCate, eqpt.EQPT_ID, "MTL_TO_OHXC_CAR_IN_SAFETY_CHECK", out vr))
                {
                    vr.afterValueChange += (_sender, _e) => CarInSafetyChcek(_sender, _e);
                }
                if (bcfApp.tryGetReadValueEventstring(eqpt.EqptObjectCate, eqpt.EQPT_ID, "MTL_TO_OHXC_CAR_IN_INTERLOCK", out vr))
                {
                    vr.afterValueChange += (_sender, _e) => CarInInterlock(_sender, _e);
                }
                ...
                if (bcfApp.tryGetReadValueEventstring(eqpt.EqptObjectCate, eqpt.EQPT_ID, "MTL_TO_OHXC_RAIL_STATUS", out vr))
                {
                    vr.afterValueChange += (_sender, _e) => MTL_LFTStatus(_sender, _e);
                }
                ...
                //    vr.afterValueChange += (_sender, _e) => MTL_LFTStatus(_sender, _e);
                //}
                if (bcfApp.tryGetReadValueEventstring(eqpt.EqptObjectCate, eqpt.EQPT_ID, "MTL_TO_OHXC_CAR_IN_REQUEST_CANCEL_HS", out vr))
                {
                    vr.afterValueChange += (_sender, _e) => MTL_CarInRequestCancel(_sender, _e);
                }
                if (bcfApp.tryGetReadValueEventstring(eqpt.EqptObjectCate, eqpt.EQPT_ID, "MTL_TO_OHXC_MANUAL_CAR_OUT_REQUEST_HS", out vr))
                {
                    vr.afterValueChange += (_sender, _e) => MTL_ManualCarOutRequest(_sender, _e);
                }
                if (bcfApp.tryGetReadValueEventstring(eqpt.EqptObjectCate, eqpt.EQPT_ID, "MTL_TO_OHXC_MANUAL_CAR_OUT_FINISH_HS", out vr))
                {
                    vr.afterValueChange += (_sender, _e) => MTL_ManualCarOutFinish(_sender, _e);
                }
                if (bcfApp.tryGetReadValueEventstring(eqpt.EqptObjectCate, eqpt.EQPT_ID, "MTL_TO_OHXC_SAFETY_CHECK", out vr))
                {
                    vr.afterValueChange += (_sender, _e) => MTLSafetyStatusChanged(_sender, _e);
                }
            }
            catch (Exception ex)
            {
