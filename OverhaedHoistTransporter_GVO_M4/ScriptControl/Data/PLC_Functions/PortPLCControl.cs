...
namespace com.mirle.ibg3k0.sc.Data.PLC_Functions
{
    ...
    class PortPLCControl_AssignCSTID : PLC_FunBase
    {
        public DateTime Timestamp;

        [PLCElement(ValueName = "ASSIGN_CST_ID")]
        public string AssignCSTID;
    }

    class PortPLCControl_TimeoutSetting : PLC_FunBase
    {
        public DateTime Timestamp;

        [PLCElement(ValueName = "T1_TIMEOUT")]
        public int T1_Timeout;
        [PLCElement(ValueName = "T2_TIMEOUT")]
        public int T2_Timeout;
        [PLCElement(ValueName = "T3_TIMEOUT")]
        public int T3_Timeout;
        [PLCElement(ValueName = "T4_TIMEOUT")]
        public int T4_Timeout;
        [PLCElement(ValueName = "T5_TIMEOUT")]
        public int T5_Timeout;
        [PLCElement(ValueName = "T6_TIMEOUT")]
        public int T6_Timeout;
