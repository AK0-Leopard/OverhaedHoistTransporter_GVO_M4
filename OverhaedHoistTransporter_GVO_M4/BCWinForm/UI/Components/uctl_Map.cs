...
namespace com.mirle.ibg3k0.bc.winform.UI.Components
{
    public partial class uctl_Map : UserControl
    {
        ...
        private void initialMapSpace()
        {
            ...
            //else if (BCFUtility.isMatche(mainForm.BCApp.SCApplication.BC_ID, SCAppConstants.WorkVersion.VERSION_NAME_UMTC))
            else if (mainForm.BCApp.SCApplication.BC_ID.StartsWith(SCAppConstants.WorkVersion.VERSION_NAME_UMTC))
            {
                space_Height_m = 70000; //CAAGVC00 地圖地圖大小
                space_Width_m = 170000;
                zoon_Factor = 130;
                defaultMaxScale = 10;
            }
            else if (BCFUtility.isMatche(mainForm.BCApp.SCApplication.BC_ID, SCAppConstants.WorkVersion.VERSION_NAME_PTI))
            {
                space_Height_m = 55000; //ASE_K21 地圖地圖大小
                space_Width_m = 52000;
                zoon_Factor = 130;
            ...
            else if(BCFUtility.isMatche(mainForm.BCApp.SCApplication.BC_ID, SCAppConstants.WorkVersion.VERSION_NAME_CHOT))
            {
                space_Height_m = 55000; //ASE_K21 地圖地圖大小
                space_Width_m = 52000;
                zoon_Factor = 130;
            ...
            else if(BCFUtility.isMatche(mainForm.BCApp.SCApplication.BC_ID, SCAppConstants.WorkVersion.VERSION_NAME_AT_S_OHTC_301))
            {
                space_Height_m = 28000; //AT&S 301 地圖大小
                space_Width_m = 26000;
                zoon_Factor = 70;
                defaultMaxScale = 13;
            }
        ...
        private void adjustTheLayerOrder()
        {
            ...
            if (m_objItemPortNew != null)
            {
                for (int ii = 0; ii < m_objItemPortNew.Count(); ii++)
                {
                    m_objItemPortNew[ii].BringToFront();
                }
            }
